...
import (
	...
	"go-lodging/internal/driver"
	"go-lodging/internal/forms"
	"go-lodging/internal/helpers"
	"go-lodging/internal/models"
	"go-lodging/internal/render"
	"go-lodging/internal/repository"
	"go-lodging/internal/repository/dbrepo"
	"log"
	"net/http"
	"strconv"
	"strings"
...
// SingleRooms renders the room page
func (m *Repository) SingleRooms(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "single-rooms.page.tmpl", &models.TemplateData{})
}
